...
while True:
   ...
   # ~~~~~~~~~~~~~~~~~~~~~
    ...
    spikes_df, purpleAir_runtime, sensors_dict = GetSort_Spikes.workflow(purpleAir_api,
                                                                         pg_connection_dict,
                                                                          spike_threshold)
    ...
    if len(sensors_dict['new']) > 0:
        ...
        messages, record_ids_to_text = New_Alerts.workflow(new_spikes_df,
                             purpleAir_runtime,
                              messages, 
                              record_ids_to_text, 
                              can_text, 
    ...
    if len(sensors_dict['ongoing']) > 0:
        ...
        Ongoing_Alerts.workflow(ongoing_spikes_df,
                                 pg_connection_dict)
